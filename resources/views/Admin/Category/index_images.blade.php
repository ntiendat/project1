...
@section('content')
     <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Danh mục Image Box</a></li>
      </ol>
    </nav>
    <div id="page-wrapper">
        <div class="row" style="position: relative;">
            ...
            <div class="form div-select" style="">
                <input  type="text" placeholder="Tìm kiếm..." id="typeCatepost">
            </div>
           <div class="form div-select " style="">
            ...
            <div class="form div-add" style="">
                  <a href="{{route('create.category',3)}}" class="btn btn-warning" style="margin-bottom: 5px"><i class="fa fa-plus"></i> Thêm mới</a>  
            </div>
        </div>
        <br>
         <table id="someTable" class="table table-striped table-hover table-primary" >
                ...
                <tbody>
                <?php tableCategoriesAll($category) ?>
                </tbody>
            </table>
...
@section('script-bottom')
     <script type="text/javascript">
        ...
        $('#typeCatepost').on('keyup',function(){
            $value = $(this).val();
            // alert($value);
            $type = $('#type').val();
            $.ajax({
                type: 'get',
                url: '{{ route('search.cate',3) }}',
                data: {
                    'search': $value,
                    'type': $type,
                },
