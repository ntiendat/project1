...
@section('content')
     <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Danh mục Video Box</a></li>
      </ol>
    </nav>
    <div id="page-wrapper">
        <div class="row" style="position: relative;">
           ...
           <div class="form div-select " style="">
            ...
            <div class="form div-add" style="">
                  <a href="{{route('create.category',4)}}" class="btn btn-warning" style="margin-bottom: 5px"><i class="fa fa-plus"></i> Thêm mới</a>  
            </div>
        </div>
        <br>
