...
@section('content')
     <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><i class="fa fa-home"></i><a href="{{route('index.product.category')}}">Danh sách loại</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="#">Sửa loại sản phẩm</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md" style="padding-bottom:120px">
                        <form class="outer-repeater needs-validation" novalidate action="{{route('update.category.product',$category->id)}}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <div id="div_albumb" name="div_albumb" style="padding-top: 20px">
                                     <div id="img_thumb" style="width:200px;height:200px;position:relative;">
                                        <img  id="img_product" name="img_product" src="{{asset('Media/'.$category->url)}}" style="padding:5px" alt="" width="200px" height="200px">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="chk" {{$category->displayed == true ? 'checked' : ''}} name="displayed">
                            </div>
                            <div class="col-sm-8 text-sm-center">
                                <button type="submit" class="btn btn-success">Sửa loại sản phẩm</button>
                                <button type="reset" class="btn btn-info">Nhập hết lại</button>
                            </div>
                            <input type="hidden" name ="image_pro" value=" {{$category->Media == true ? $category->Media->id : ''}}" id="image_pro">
