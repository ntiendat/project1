...
<div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="form-group">
        <label for=""></label>
        <input type="text"
          class="form-control" name="menu_name" value="{{$menus[0]->menu_name}}" id="menu_name_master" aria-describedby="helpId" placeholder="">
      
      </div>
      <div class="form-group">
        <label for=""></label>
        <input type="text"
          class="form-control" name="title" value="{{$menus[0]->title}}" id="title_master" aria-describedby="helpId" placeholder="">
          {{-- class="form-control" name="title" value="{{$menus[0]->title}}" id="title_master" aria-describedby="helpId" placeholder=""> --}}
        
        <input type="text"
          class="form-control" hidden name="master_menu_id" value="{{$menus[0]->id}}" id="master_menu_id" aria-describedby="helpId" placeholder="">
    ...
    function edit_click_id(id,type) {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                console.log(data);
                console.log("name-label-"+type+"_"+data['id']);
                $( "#name-label-"+type+"_"+data['id'] ).text(name);
            },
            ...
            if(value.type == 5){
              $('#' + node).append(`
                    ...
                    <div id="show-hidden-url_${value.id}">
                        ...
                        <input type='hidden' value='${value.link_id}' id='link_id'>
