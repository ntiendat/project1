 <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="div-right" style="text-align: center;">
            <p class="name-cate" style=" ">Galary ảnh</p>
            <!-- Button to Open the Modal -->
            <button type="button" id="selectoneimage" class="btn btn-primary select-image">
              Chọn ảnh
            </button>
            <div>
               {{--  <img id="img_product" name="img_product" width="90%" height="120px" alt=""> --}}
                @foreach($galary_img as $galary_img)
                    <img id="img_product" name="img_product" src="../../../Media/{{$galary_img->url}}" width="90%" height="120px" alt="">
                @endforeach
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h4 class="modal-title">Chọn galary ảnh</h4>
